...
<table class="bordered">
    ...
    <c:forEach var="resultBundle" items="${resultBundles}">
        <tr>
            ...
            <c:forEach var="fileBundle" items="${resultBundle.fileBundleViews}">
                <td>
                    <div style="witdh: 100%;">
                        <div style="width: 30%; float: left; padding-left: 20%;">
                        ...
                        <div style="width: 30%; float: left; padding-right: 20%;">
                            <a href="" class="blue button">Trigger</a>
                        </div>
                    </div>
                </td>
            </c:forEach>
